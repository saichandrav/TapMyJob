...
function JobRow({ job, isSaved, onSelect, onToggleSave }) {
  return (
    <button
      type="button"
      onClick={onSelect}
      className="w-full rounded-3xl border border-border bg-surface/80 p-4 text-left transition hover:border-primary/40 hover:bg-gray-100"
    >
        ...
        <div className="rounded-[1.75rem] border border-border bg-surface/90 p-6 shadow-card-glow">
          <div className="mb-5 flex items-center justify-between gap-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-2xl border border-border bg-card px-4 py-2 text-sm text-text-primary transition hover:border-primary/40 hover:bg-gray-100"
            >
